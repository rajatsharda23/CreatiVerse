...
// node_modules/sanity/lib/_chunks/desk-cdc37ed9.js
...
var PaneHeaderActions = (0, import_react.memo)(function PaneHeaderActions2(props) {
  const {
    initialValueTemplateItems: initialValueTemplateItemsFromStructure = EMPTY_ARRAY$8,
    menuItems = EMPTY_ARRAY$8,
    menuItemGroups = EMPTY_ARRAY$8,
...
var deskTool = definePlugin((options) => ({
  ...
  tools: [{
    ...
    component: (0, import_react.lazy)(() => import("./index-990e561a-X6M6YFUR.js").then(function(n) {
      return n.index;
    })),
...
//# sourceMappingURL=chunk-ZLNNOAKJ.js.map
